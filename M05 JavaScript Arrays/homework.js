...
function incrementarPorUno(array) {
   ...
   // Tu código:
   var sumadoUno = array.map( (valor) => { return valor + 1 } );
   return sumadoUno;
}
...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   var suma = 0;
   arrayOfNums.map( (valor) =>{ return suma += valor})
   return suma;
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   var suma = 0;
   resultadosTest.map( (valor) =>{ return suma += valor});
...
function breakStatement(num) {
   ...
   return seInterrumpio ?  "Se interrumpió la ejecución" : miArray;
